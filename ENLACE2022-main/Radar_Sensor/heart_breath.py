...
def Breath_Heart(Msg):
    ...
    if Msg[2].to_bytes(1, 'big') == BREATH_RATE_RADAR:
        if Msg[3].to_bytes(1, 'big') == BREATH_DATA:
            ...
            os.system("python3 Adafruit_Python_SSD1306/examples/stats.py heartbeat " + prevVal + " " + str(Msg[6]))
        ...
        if Msg[3].to_bytes(1, 'big') == RATE_DATA:
            ...
            os.system("python3 Adafruit_Python_SSD1306/examples/stats.py heartbeat "  + str(Msg[6]) + " " + prevVal)
            prevVal = str(Msg[6])
